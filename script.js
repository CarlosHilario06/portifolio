const translations = {
  pt: {
    ...
    heroTitle: 'Desenvolvimento Full Stack para produtos, automações e interfaces que funcionam de verdade.',
    heroText: 'Sou Carlos Hilário, desenvolvedor focado em SaaS e automação com JavaScript. Construo soluções web com estrutura, clareza e atenção ao que o usuário realmente precisa fazer na tela.',
    ...
    skillsTitle: 'Tecnologias organizadas por função, não por porcentagem aleatória.',
  ...
  en: {
    ...
    heroTitle: 'Full Stack development for products, automations and interfaces that actually work.',
    heroText: 'I am Carlos Hilário, a developer focused on SaaS and JavaScript automation. I build web solutions with structure, clarity and attention to what the user really needs to do on the screen.',
    heroPrimary: 'View projects',
    heroSecondary: 'Message on WhatsApp',
    panelStatus: 'available for new projects',
    profileText: '20 years old · SaaS · Automation',
    aboutEyebrow: 'About me',
    aboutTitle: 'I like turning loose ideas into navigable, organized products ready to evolve.',
    ...
    skillsTitle: 'Technologies organized by function, not random percentages.',
